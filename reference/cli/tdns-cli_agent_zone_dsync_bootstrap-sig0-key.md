## tdns-cli agent zone dsync bootstrap-sig0-key

Send dsync bootstrap command to the agent

```
tdns-cli agent zone dsync bootstrap-sig0-key [flags]
```
...
```
  ...
  -h, --help               help for bootstrap-sig0-key
```
