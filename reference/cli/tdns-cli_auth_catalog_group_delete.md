## tdns-cli auth catalog group delete

Remove a group from the catalog's group list

```
tdns-cli auth catalog group delete --cat <catalog-zone> --group <group-name> [flags]
```
