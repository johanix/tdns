## tdns-cli agent zone update create
...
```
tdns-cli agent zone update create [flags]
```
...
* [tdns-cli agent zone update](tdns-cli_agent_zone_update.md)	 - Create and ultimately send a DNS UPDATE msg for zone auth data
