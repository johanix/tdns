module github.com/johanix/tdns/v0.x/cli

go 1.24.0

replace (
	github.com/johanix/tdns/v0.x => ../
	github.com/johanix/tdns/v0.x/cache => ../cache
	github.com/johanix/tdns/v0.x/core => ../core
	github.com/johanix/tdns/v0.x/edns0 => ../edns0
)
...
require (
	...
	github.com/johanix/tdns/v0.x/cache v0.0.0-20251209183459-2d9962c12f9f
