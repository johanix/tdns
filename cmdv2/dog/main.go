...
// dog builds with CGO_ENABLED=0 (statically-linked dig replacement).
// The liboqs-backed algorithms (falcon512, mayo1, snova24_5_4) require
// CGO and are deliberately omitted here. Their codepoints are still
// registered as metadata so dog's validation accepts the names —
// actual signing/verifying with them is not possible from this binary.
func init() {
