...
// func (rrset *core.RRset) RemoveRR(rr dns.RR) {
...
// func (rrset *core.RRset) Copy() *core.RRset {
//	new_rrset := core.RRset{
//		Name:   rrset.Name,
//		RRs:    []dns.RR{},
//		RRSIGs: []dns.RR{},
//	}
...
// func (rrset *core.RRset) Add(rr dns.RR) {
...
//func (rrset *core.RRset) Delete(rr dns.RR) {
