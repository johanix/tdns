...
// SvcbTransportKey is the private-use SVCB key used to carry transport weights (pct).
// RFC 9460 reserves 65280–65534 for private use; this may change in the future, so
// reference this constant rather than hard-coding the number.
