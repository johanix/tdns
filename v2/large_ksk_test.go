...
func TestResolveLargeAlgorithms(t *testing.T) {
	...
	tests := []struct {
		...
		{"exact trims whitespace", []string{"  MLDSA44 "}, []uint8{18}, false},
		{"prefix expands family", []string{"MLDSA*"}, []uint8{18, 212, 213}, false},
		{"prefix case-insensitive", []string{"mldsa*"}, []uint8{18, 212, 213}, false},
		{"prefix single member", []string{"CROSS*"}, []uint8{214}, false},
		{"prefix narrows within family", []string{"MLDSA8*"}, []uint8{213}, false},
		{"bare star matches all", []string{"*"}, []uint8{10, 18, 200, 212, 213, 214}, false},
