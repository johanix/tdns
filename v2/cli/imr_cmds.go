...
func init() {
	...
	// Add ping and daemon commands to ImrCmd (NewPingCmd/NewDaemonCmd are defined elsewhere)
	ImrCmd.AddCommand(NewPingCmd("imr"))
	ImrCmd.AddCommand(NewDaemonCmd("imr"))
}
