...
containing either the private or the public SIG(0) key and the name of the zone.`,
	...
	c.AddCommand(add, importCmd, generate, list, delete, setstate, genDS, rollover, clear, newKeystoreDnssecPolicyCmd(role), newKeystoreDnssecDsPushCmd(role), newKeystoreDnssecQueryParentCmd(role))
	return c
}
